...
function alphabetFromIdentifier(alphabet: Alphabet): string {
  if (alphabet === 'base64') {
...
export function uint8ArrayToBase64(arr: Uint8Array, alphabetIdentifier: Alphabet = 'base64', more = false, origExtra: Uint8Array | null = null): { result: string, extra: Uint8Array | null } {
  checkUint8Array(arr);
...
export function base64ToUint8Array(str: string, alphabetIdentifier: Alphabet = 'base64', more = false, origExtra = null): { result: Uint8Array, extra: string | null } {
