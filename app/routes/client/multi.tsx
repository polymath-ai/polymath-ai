...
export default function ClientMulti() {
  const { name } = useLoaderData<typeof loader>();
  const fetcher = useFetcher();

  return (
    <div style={{ fontFamily: "system-ui, sans-serif", lineHeight: "1.4" }}>
      <h1>Polymath: Multi Endpoint Client</h1>

      <p>TODO: This will let you select and deselect multiple endpoints to get results and sources from.</p>
